...
Single loop learning feels so much better than double loop learning. Double loop learnign required we get past the cognitive bias that says we have a consistent explanation for how the bits of the world we care about works.
...
There is a useful (but ultimately wrong) model of how our brains work, called the Triuine Brain. This suggests that there are 3 areas, or thinking states that we use. The lowest brain is the Reptilian brain. This is the fight or flight response. Knowing we are physically safe keeps this brain quiet. Feeling unsafe activates this brain. Fight also can mean get angry...
...
If you're safe, and you know the rules, then you can use the Neo-Cortex, or learning brain. I'm going to suggests that this is more accurately called the Single Loop Learning Brain. You can learn a new Language, or how to use your current skills better. It's saying "Don't worry, you know the answers."
...
Is being a consultant wiht a complete list a barrier to your brain double loop leaning? (I don't expect this is what Simon says he is. Other strategy consultants may not.)

## Example 3 Hackernoon
This article is delecious. David sets up the reader with the problem that's hard enought notto dismiss out of hand. It's a challenge to the expert. He then uses the experts heuristics and shows how they are wrong. I'd imagine some readers are rapidly thinging how to fix the problem, and ones like it. Workign in the IT industry I imagine there may be a few angry readers too.


Has this article, about double loop learing offered any double loop learning. Why is this article wrong?
